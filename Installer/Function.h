...
extern int CheckDestinationDirectory(CString strFilePath);
...
//	自定义消息
#define THREAD_INSTAL_OVER			WM_USER+0x0001

//	生成资源文件线程处理结果
#define INSTAL_STATUS_SUCCESS		0
#define INSTAL_STATUS_FAIL			1
#define INSTAL_STATUS_CANCEL		2
